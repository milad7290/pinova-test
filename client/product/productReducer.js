...
const ProductReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case SET_NAME :
      return {...state,name:action.name,nameStatus:false,quantityStatus:true,priceStatus:true};
    case SET_QUANTITY :
      return {...state,quantity:action.quantity,quantityStatus:false,nameStatus:true,priceStatus:true};
    case SET_PRICE :
      return {...state,price:action.price,priceStatus:false,nameStatus:true,quantityStatus:true};
    case ADD_PRODUCTS :
      return {...state,data:[...action.products]};
    case SET_PRISTAN_FALSE :
      return {...state,nameStatus:false,quantityStatus:false,priceStatus:false};
    default:
      return state;
  }
};
